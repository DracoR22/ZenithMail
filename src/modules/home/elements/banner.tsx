...
const Banner = () => {
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="214" height="214" fill="none" className="absolute block -top-3 -left-24 md:-left-0">
    ...
    <div className="w-full h-full flex justify-center items-center relative overflow-hidden">
      <Image src={ "https://media.beehiiv.com/cdn-cgi/image/fit=scale-down,onerror=redirect,format=auto,width=1920,quality=75/www/homepage/MobileHero.png"}
        alt=""  width={800} height={500} className="w-[80%] object-cover spin-slow"/>
